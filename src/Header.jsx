...
export default function Header() {
    ...
    return(
        <div className="mt-[56px] bg-[#1f1f1f]">
            <div className="flex items-center justify-between h-[87px] min-[992px]:w-[990px] min-[992px]:mx-auto min-[1200px]:w-[1180px] min-[1400px]:w-[1380px]">
                ...
                <div>
                    <a href="https://themeforest.net/checkout/102772226/create_account?clickid=z8bxQtV2cxyPRPUxoCTql0XVUkHX9cSfcVO63Q0&iradid=275988&iradtype=ONLINE_TRACKING_LINK&irgwc=1&irmptype=mediapartner&irpid=3544009&mp_value1=&utm_campaign=af_impact_radius_3544009&utm_medium=affiliate&utm_source=impact_radius">
                        <button className="border-white border-2 px-5 py-2 rounded-full trasition-all duration-300 hover:bg-white hover:text-black">Purchase</button>
                    </a>
                </div>
            </div>
            <hr className="border border-[#2f2f2f]" />
            <div ref={ref1} className={`mt-44 ${isVisible1 ? "header-slider" : ""}`}>
                <div className="w-[400px] mx-auto md:w-[700px] min-[992px]:w-[650px] min-[1400px]:w-[900px]">
                    <div className="flex gap-2 w-fit mx-auto tracking-[.15em]">
                        <img src="https://uithemez.com/i/geekfolio/landing-preview/img/star.svg" />
                        <h3 className="text-sm -mt-0.5">AWESOME TEMPLATE</h3>
                    </div>
                    <h1 className="text-4xl text-center tracking-wide leading-[45px] font-light mt-2 md:text-[80px] md:leading-[100px]">A <strong className="font-bold">perfect</strong> Place for Your Creative <strong className="font-bold">Portfolio.</strong></h1>
                </div>
            </div>
        </div>
    )
